...
# config = AutoConfig.from_pretrained('allenai/scibert_scivocab_cased', num_labels=3)#args['task_name']
# #config = AutoConfig.from_pretrained('/home/infolab/env_py3_yunhe/BERT_LM_logits_aws/outputs_pretrain-logtis-bert-10/checkpoint-2438', num_labels=3)#args['task_name']
# #config = config_class.from_pretrained(args['model_name'], num_labels=3)#args['task_name']
# tokenizer = AutoTokenizer.from_pretrained('allenai/scibert_scivocab_cased')#emilyalsentzer/Bio_Discharge_Summary_BERT##allenai/scibert_scivocab_uncased
# #tokenizer = tokenizer_class.from_pretrained(args['model_name'])#'/home/infolab/env_py3_yunhe/BERT_LM_logits_aws/bioBERT'
# #model = model_class.from_pretrained(args['model_name'], config=config)#
# model = AutoModelForTokenClassification.from_pretrained('allenai/scibert_scivocab_cased', config=config)#
# #model = AutoModelForTokenClassification.from_pretrained('/home/infolab/env_py3_yunhe/BERT_LM_logits_aws/outputs_pretrain-logtis-bert-10/checkpoint-2438', config=config)

### change path here for your BERT model pretrained by disease_knowledge_infusion_training.py
config = AutoConfig.from_pretrained('/home/infolab/env_py3_yunhe/BERT_LM_logits_aws/outputs_pretrain/checkpoint-2438', num_labels=3)#args['task_name']
tokenizer = tokenizer_class.from_pretrained(args['model_name'])
model = model_class.from_pretrained('/home/infolab/env_py3_yunhe/BERT_LM_logits_aws/outputs_pretrain/checkpoint-2438', config=config)
...
def evaluate(model, tokenizer, mode, prefix=""):
...
def final_test(mode):
    ...
    for checkpoint in checkpoints:
        ...
        model.to(device)
        #classificationlLayerMedNLI.to(device)
        result = evaluate(model, tokenizer, mode, prefix=global_step)
...
if __name__ == "__main__":
    #final_train('trainAndDevelopment')
    #final_test('eval')
    final_test('test')