...
args = {
    ...
    'model_name': 'bert-base-uncased',#'albert-xlarge-v2'
...
#model = model_class.from_pretrained('/home/ubuntu/BERT-MEDIQA-maskedLM/outputs_pretrain-maskQuestion-25randomMaskAnswer/checkpoint-2438')
...
def final_test(mode):
    ...
    for checkpoint in checkpoints:
        ...
        if mode=='test':
            answer_file_path = 'groundTruth_trecQA.txt'
        else:
...
if __name__ == "__main__":
	#print(tokenizer.tokenize('bacteremia'))
	#final_train()
	final_test('dev')
	final_test('test')