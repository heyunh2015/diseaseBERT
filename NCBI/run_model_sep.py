...
#config = AutoConfig.from_pretrained('allenai/scibert_scivocab_uncased', num_labels=3)#args['task_name']
#config = AutoConfig.from_pretrained('/home/infolab/env_py3_yunhe/BERT_LM_logits_aws/outputs_pretrain-logtis-biobert-10/checkpoint-2438', num_labels=3)#args['task_name']
#config = AutoConfig.from_pretrained(args['model_name'], num_labels=3)#args['task_name']
#tokenizer = AutoTokenizer.from_pretrained('/home/infolab/env_py3_yunhe/BERT_LM_logits_aws/bioBERT')#emilyalsentzer/Bio_Discharge_Summary_BERT##allenai/scibert_scivocab_uncased
...
#model = AutoModelForTokenClassification.from_pretrained('/home/infolab/env_py3_yunhe/BERT_LM_logits_aws/outputs_pretrain-logtis-biobert-10/checkpoint-2438', config=config)
